  ...
  const onFinish = (values: any) => {
    ...
    let updatedValues: any = {
      savingsProduct: {
        ...
        depositTypeEnum: "RECURRING DEPOSIT",
      ...
      depositProductTermAndPreClosure: {
        minDepositTerm:
          formValues.depositProductTermAndPreClosure?.minDepositTerm,
        maxDepositTerm:
          formValues.depositProductTermAndPreClosure?.maxDepositTerm,
        ...
        depositAmount:
          formValues.depositProductTermAndPreClosure?.depositAmount,
        preClosurePenalInterest:
          formValues.depositProductTermAndPreClosure?.preClosurePenalInterest,
      },
      interestRateChart: {
        fromDate: formValues.interestRateChart?.fromDate,
        endDate: formValues.interestRateChart?.endDate,
        isPrimaryGroupingByAmount:
          formValues.interestRateChart?.isPrimaryGroupingByAmount,
      },
      interestRateSlabs: formValues.interestRateChart?.interestRateSlabs,
    };
